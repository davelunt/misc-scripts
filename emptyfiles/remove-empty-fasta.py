...
def move_empty_or_whitespace_only_fasta_files(source_directory, target_directory):
    ...
    for file_path in source_path.rglob('*'):
        if file_path.is_file() and file_path.suffix in {'.fasta', '.fa'}:  # Check for .fasta or .fa files
...
move_empty_or_whitespace_only_fasta_files(source_directory, target_directory)